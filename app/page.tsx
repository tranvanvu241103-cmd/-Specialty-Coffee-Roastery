export default function HomePage() {
  return (
    <div className="bg-[#f7f3e9] font-inter min-h-screen">
      {/* Bao ngoài cùng để căn giữa */}
      <div className="max-w-screen-xl mx-auto px-4 md:px-8 lg:px-12">
        
        {/* Navigation Bar */}
        <nav className="bg-[#4a2c2a] text-white p-4 rounded-b-lg">
        ...
        {/* Hero Section */}
        <header className="relative text-center text-white p-6 sm:p-12 bg-[#4a2c2a] rounded-lg mt-4">
        ...
        {/* Footer */}
        <footer className="bg-[#4a2c2a] text-white p-8 text-center rounded-t-lg">
